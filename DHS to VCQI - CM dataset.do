...
*										If yes, create dataset with 1 weight per respondent 
*										in survey type.
*										Copied changes from MICS updates
********************************************************************************
...
bysort HH03 : gen expected_hh_to_visit =total(firsthm) //(_N) // Double check to ensure this appropriately calculated.
